...
class CartController extends Controller
{
    ...
    public function store(CartRequest $request)
    {
        try {
            ...
            $cartDetails = $cart->with('cart_details')->where('uuid',$request->uuid)->get();
    ...
    {
        $cart = $this->cart->with('cart_details')->where([
            'uuid' => $id
        ])->get();
    ...
    public function destroy($id)
    {
        try {
            ...
            //  Fetch All Cart Details
            $cartDetails = $cart->with('cart_details')->where('uuid',$cart->uuid)->get();
